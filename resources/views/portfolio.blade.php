        ...
        <div class="container">
            ...
            <div class="row g-4 portfolio-grid">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item" data-category="app">
                    <div class="card border-0 shadow-sm overflow-hidden">
                        <div class="portfolio-img-wrapper">
                            <img src="https://placehold.co/600x400/000000/FFF" class="card-img-top" alt="Travel App">
                            <div class="portfolio-overlay">
                                <div class="overlay-content">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item" data-category="web">
                    <div class="card border-0 shadow-sm overflow-hidden">
                        <div class="portfolio-img-wrapper">
                            <img src="https://picsum.photos/seed/picsum/450/300" class="card-img-top" alt="Restaurant Website">
                            <div class="portfolio-overlay">
                                <div class="overlay-content">
    ...
    <div class="modal fade" id="project4Modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="https://picsum.photos/200/300?image=0" class="img-fluid mb-4" alt="Brand Identity">
    ...
    <div class="modal fade" id="project5Modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="https://picsum.photos/450?grayscale" class="img-fluid mb-4" alt="Travel App">
    ...
    <div class="modal fade" id="project6Modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="https://picsum.photos/id/1/200/300" class="img-fluid mb-4" alt="Restaurant Website">
